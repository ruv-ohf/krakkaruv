function CEndPanel(oSpriteBg){
    ...
    this._init = function(oSpriteBg){
        ...
        _oMsgTextBack = new createjs.Text("","bold 56px comic_sans_msregular", "#000");
        _oMsgTextBack.x = CANVAS_WIDTH/2 +2;
        _oMsgTextBack.y = (CANVAS_HEIGHT/2)-76;
        _oMsgTextBack.textAlign = "center";

        _oMsgText = new createjs.Text("","bold 56px comic_sans_msregular", "#ffffff");
        _oMsgText.x = CANVAS_WIDTH/2;
        _oMsgText.y = (CANVAS_HEIGHT/2)-80;
        _oMsgText.textAlign = "center";
        
        _oScoreTextBack = new createjs.Text("","bold 40px comic_sans_msregular", "#000");
        _oScoreTextBack.x = CANVAS_WIDTH/2 +1;
        _oScoreTextBack.y = (CANVAS_HEIGHT/2)+34;
        _oScoreTextBack.textAlign = "center";
        
        _oScoreText = new createjs.Text("","bold 40px comic_sans_msregular", "#ffffff");
