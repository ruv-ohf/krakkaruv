function RenderLoadingBar_Standard(_graphics, _width,_height, _total, _current, _loadingscreen) 
{
	...
	if (_loadingscreen)
	{
		...
		_graphics.drawImage(_loadingscreen, 260, 156, 504, 127);
		//draw Text
		jsDrawCenteredText(_graphics, _width / 2, (_height *0.70), "rgba(151,153,154,255)", "Learning is a treasure that will follow its owner everywhere.");
		jsDrawCenteredText(_graphics, _width / 2, (_height *0.73), "rgba(141,143,144,155)", "                         Chinese Proverb");
	} 
}
